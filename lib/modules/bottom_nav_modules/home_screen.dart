...
class _HomeScreenState extends State<HomeScreen> {
      ...
      child: BlocConsumer<appCubit, appStates>(
        ...
        builder: (context, state) {
          ...
          return ConditionalBuilder(
            condition: cubit.homeModel != null && cubit.favoritesModel != null,
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              GridView.count(
                                ...
                                crossAxisSpacing: 2,
                                crossAxisCount: 2,
                                children: List.generate(20, (index) => ProductHome(x![index],cubit)),
                              ),
                            ],
                          ),
                        ),
  ...
  Widget ProductHome(ProductModel model,appCubit cubit) => Column(
    children: [
      Stack(
            ...
            Row(
              ...
              children: [
                ...
                IconButton(
                  onPressed: (){
                    setState(() {});
                    cubit.postFavoriteProduct(IdProduct: model.id);

                  },
                  icon: cubit.list.contains(model.id) ? Icon(Icons.favorite_outlined,color: Colors.red,) : Icon(Icons.favorite_border_outlined),
                ),
              ],
            ),
          ],
